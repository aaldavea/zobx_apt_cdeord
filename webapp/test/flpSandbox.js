		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create decomission order",
									"targetURL": "#Createdecomissionorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Createdecomissionorder-display": {
								"semanticObject": "Createdecomissionorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.build.custom.zobx_apt_cdeord",
									"url": sap.ui.require.toUrl("com/sap/build/custom/zobx_apt_cdeord")
								}
							}
						}
					}
